...
namespace UpworkPdfGenerator.Lib.Utilities
{
    public static class ResourcesUtilities
    {
        ...
        public static Stream ReadFileAsStream(string name, Assembly? assembly = null)
        {
            ...
            try
            {
                return assembly.GetManifestResourceStream(assembly
            ...
            catch (InvalidOperationException exception)
            {
                throw new ArgumentException(
                    ...
                    "Make sure there are no collisions and the required file has the attribute \"Embedded resource\"", exception);
            }
        }
